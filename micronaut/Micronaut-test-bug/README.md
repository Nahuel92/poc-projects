...
Example project to attach to the bug reports:
...
I noticed a couple of bugs related to Micronaut Data and/or Test involving the annotation `@Transactional`.
...
> **Important:** The second bug test case can't be caught during testing (at least, I couldn't figure out how to do so),
> which makes it more concerning.